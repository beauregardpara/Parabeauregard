    ...
    <ContentPage title="Contactez-nous" subtitle={subtitle}>
      <div className="grid gap-4 sm:grid-cols-3">
        <div className="rounded-2xl border border-para-100 bg-white p-5 text-center shadow-sm">
          ...
          <p className="mt-3 text-xs font-bold uppercase tracking-wide text-slate-500">Téléphone</p>
        ...
        <div className="rounded-2xl border border-para-100 bg-white p-5 text-center shadow-sm">
          ...
          <p className="mt-3 text-xs font-bold uppercase tracking-wide text-slate-500">Email</p>
        ...
        <div className="rounded-2xl border border-para-100 bg-white p-5 text-center shadow-sm">
          ...
          <p className="mt-3 text-xs font-bold uppercase tracking-wide text-slate-500">Localisation</p>
